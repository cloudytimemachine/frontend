...
/***/ function(module, exports, __webpack_require__) {
	...
	var CaptureMetaInformation = React.createClass({
	  displayName: 'CaptureMetaInformation',
	...
	var CaptureDetailScreen = React.createClass({
	  displayName: 'CaptureDetailScreen',
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('img', { className: 'captureDetails', src: imgLink }),
	      React.createElement(CaptureMetaInformation, {
	...
	ReactDOM.render(React.createElement(CaptureDetailScreen, { url: captureURL }), document.getElementById('capture'));
